package cn.mosaandnasa.com.Owen.view;
...
import cn.mosaandnasa.com.Owen.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String URL_DOMAIN_cn = "http://m-owen.mosaandnasa.com.cn/Admin/Index/?Token="; //大陸
    private String URL_DOMAIN = "http://m-owen.mosaandnasa.com/Admin/Index/?Token="; //台灣
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (webView.canGoBack()) {
                ...
                if(isTaiwan)return true;// 台灣暫不使用
                //
                AlertDialog.Builder dialog = new AlertDialog.Builder(MainActivity.this,android.R.style.Theme_DeviceDefault_Light_Dialog_MinWidth);
                dialog.setTitle("提醒");
